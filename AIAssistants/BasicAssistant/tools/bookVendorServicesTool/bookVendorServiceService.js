...
async function generateResponse(query) {
    ...
    const bookingDetails = await extractBookingDetails(query);
    ...
    if (!bookingDetails.vendorName ||
        ...
        return extractBookingTool.generateResponse(dataNeeded, dataPresent)
    }
...
async function extractBookingDetails(userMessage) {
    const systemMessage = `
